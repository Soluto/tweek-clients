...
export class TagsApi {
     ...
     */
    public saveTag (body: any) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling saveTag.');
        }
