import React, { ComponentType, Context, FunctionComponent, ReactType } from 'react';
...
) => <TProps extends T>(BaseComponent: ReactType<TProps>) => ComponentType<Omit<TProps, T> & ResetOptions>;
